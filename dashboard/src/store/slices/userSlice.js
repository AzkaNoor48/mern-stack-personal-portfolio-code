...
export const login = (email, password) => async (dispatch) => {
  ...
  try {
    ...
    dispatch(userSlice.actions.loginFailed(error.response ? error.response.data.message : error));
  }
};
...
export const getUser = () => async (dispatch) => {
  ...
  try {
    ...
    dispatch(userSlice.actions.loadUserFailed(error.response ? error.response.data.message : "Unknown error"));
  }
};
